...
// This file has been hand-edited for cleanup and to add Span<T> support; do not
// blindly replace it with an updated version.
//
//=============================================================================
#if !OPENVR_XR_API
...
public struct IVRSystem
{
	...
	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	internal unsafe delegate void _GetDeviceToAbsoluteTrackingPose(ETrackingUniverseOrigin eOrigin, float fPredictedSecondsToPhotonsFromNow, [In, Out] TrackedDevicePose_t* pTrackedDevicePoseArray, uint unTrackedDevicePoseArrayCount);
	[MarshalAs(UnmanagedType.FunctionPtr)]
	...
	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	internal unsafe delegate uint _GetSortedTrackedDeviceIndicesOfClass(ETrackedDeviceClass eTrackedDeviceClass, [In, Out] uint* punTrackedDeviceIndexArray, uint unTrackedDeviceIndexArrayCount, uint unRelativeToTrackedDeviceIndex);
	[MarshalAs(UnmanagedType.FunctionPtr)]
...
public struct IVRApplications
{
	...
	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	internal unsafe delegate EVRApplicationError _LaunchTemplateApplication(IntPtr pchTemplateAppKey, IntPtr pchNewAppKey, [In, Out] AppOverrideKeys_t* pKeys, uint unKeys);
	[MarshalAs(UnmanagedType.FunctionPtr)]
...
public struct IVRChaperoneSetup
{
	...
	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	internal unsafe delegate bool _GetWorkingCollisionBoundsInfo([In, Out] HmdQuad_t* pQuadsBuffer, ref uint punQuadsCount);
	[MarshalAs(UnmanagedType.FunctionPtr)]
	internal _GetWorkingCollisionBoundsInfo GetWorkingCollisionBoundsInfo;

	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	internal unsafe delegate bool _GetLiveCollisionBoundsInfo([In, Out] HmdQuad_t* pQuadsBuffer, ref uint punQuadsCount);
	[MarshalAs(UnmanagedType.FunctionPtr)]
	...
	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	internal unsafe delegate void _SetWorkingCollisionBoundsInfo([In, Out] HmdQuad_t* pQuadsBuffer, uint unQuadsCount);
	[MarshalAs(UnmanagedType.FunctionPtr)]
	internal _SetWorkingCollisionBoundsInfo SetWorkingCollisionBoundsInfo;

	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	internal unsafe delegate void _SetWorkingPerimeter([In, Out] HmdVector2_t* pPointBuffer, uint unPointCount);
	[MarshalAs(UnmanagedType.FunctionPtr)]
...
public struct IVRCompositor
{
	...
	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	internal unsafe delegate EVRCompositorError _WaitGetPoses([In, Out] TrackedDevicePose_t* pRenderPoseArray, uint unRenderPoseArrayCount, [In, Out] TrackedDevicePose_t* pGamePoseArray, uint unGamePoseArrayCount);
	[MarshalAs(UnmanagedType.FunctionPtr)]
	internal _WaitGetPoses WaitGetPoses;

	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	internal unsafe delegate EVRCompositorError _GetLastPoses([In, Out] TrackedDevicePose_t* pRenderPoseArray, uint unRenderPoseArrayCount, [In, Out] TrackedDevicePose_t* pGamePoseArray, uint unGamePoseArrayCount);
	[MarshalAs(UnmanagedType.FunctionPtr)]
	...
	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	internal unsafe delegate uint _GetFrameTimings([In, Out] Compositor_FrameTiming* pTiming, uint nFrames);
	[MarshalAs(UnmanagedType.FunctionPtr)]
	...
	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	internal unsafe delegate EVRCompositorError _SetSkyboxOverride([In, Out] Texture_t* pTextures, uint unTextureCount);
	[MarshalAs(UnmanagedType.FunctionPtr)]
	...
	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	internal unsafe delegate EVRCompositorError _GetPosesForFrame(uint unPosePredictionID, [In, Out] TrackedDevicePose_t* pPoseArray, uint unPoseArrayCount);
	[MarshalAs(UnmanagedType.FunctionPtr)]
...
public struct IVRScreenshots
{
	...
	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	internal unsafe delegate EVRScreenshotError _HookScreenshot([In, Out] EVRScreenshotType* pSupportedTypes, int numTypes);
	[MarshalAs(UnmanagedType.FunctionPtr)]
...
public struct IVRInput
{
	...
	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	internal unsafe delegate EVRInputError _UpdateActionState([In, Out] VRActiveActionSet_t* pSets, uint unSizeOfVRSelectedActionSet_t, uint unSetCount);
	[MarshalAs(UnmanagedType.FunctionPtr)]
	...
	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	internal unsafe delegate EVRInputError _GetBoneHierarchy(ulong action, [In, Out] int* pParentIndices, uint unIndexArayCount);
	[MarshalAs(UnmanagedType.FunctionPtr)]
	...
	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	internal unsafe delegate EVRInputError _GetSkeletalReferenceTransforms(ulong action, EVRSkeletalTransformSpace eTransformSpace, EVRSkeletalReferencePose eReferencePose, [In, Out] VRBoneTransform_t* pTransformArray, uint unTransformArrayCount);
	[MarshalAs(UnmanagedType.FunctionPtr)]
	...
	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	internal unsafe delegate EVRInputError _GetSkeletalBoneData(ulong action, EVRSkeletalTransformSpace eTransformSpace, EVRSkeletalMotionRange eMotionRange, [In, Out] VRBoneTransform_t* pTransformArray, uint unTransformArrayCount);
	[MarshalAs(UnmanagedType.FunctionPtr)]
	...
	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	internal unsafe delegate EVRInputError _DecompressSkeletalBoneData(IntPtr pvCompressedBuffer, uint unCompressedBufferSize, EVRSkeletalTransformSpace eTransformSpace, [In, Out] VRBoneTransform_t* pTransformArray, uint unTransformArrayCount);
	[MarshalAs(UnmanagedType.FunctionPtr)]
	...
	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	internal unsafe delegate EVRInputError _GetActionOrigins(ulong actionSetHandle, ulong digitalActionHandle, [In, Out] ulong* originsOut, uint originOutCount);
	[MarshalAs(UnmanagedType.FunctionPtr)]
	...
	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	internal unsafe delegate EVRInputError _ShowBindingsForActionSet([In, Out] VRActiveActionSet_t* pSets, uint unSizeOfVRSelectedActionSet_t, uint unSetCount, ulong originToHighlight);
	[MarshalAs(UnmanagedType.FunctionPtr)]
...
public class CVRSystem
{
	...
	public unsafe void GetDeviceToAbsoluteTrackingPose(ETrackingUniverseOrigin eOrigin,float fPredictedSecondsToPhotonsFromNow,Span<TrackedDevicePose_t> pTrackedDevicePoseArray)
	{
		fixed (TrackedDevicePose_t* poses = pTrackedDevicePoseArray)
			FnTable.GetDeviceToAbsoluteTrackingPose(eOrigin,fPredictedSecondsToPhotonsFromNow,poses,(uint) pTrackedDevicePoseArray.Length);
	}
	...
	public unsafe uint GetSortedTrackedDeviceIndicesOfClass(ETrackedDeviceClass eTrackedDeviceClass,Span<uint> punTrackedDeviceIndexArray,uint unRelativeToTrackedDeviceIndex)
	{
		fixed (uint* indexArray = punTrackedDeviceIndexArray)
        {
			uint result = FnTable.GetSortedTrackedDeviceIndicesOfClass(eTrackedDeviceClass,indexArray,(uint) punTrackedDeviceIndexArray.Length,unRelativeToTrackedDeviceIndex);
			return result;
        }
	}
...
public class CVRApplications
{
	...
	public unsafe EVRApplicationError LaunchTemplateApplication(string pchTemplateAppKey,string pchNewAppKey,Span<AppOverrideKeys_t> pKeys)
	{
		fixed (AppOverrideKeys_t* keys = pKeys)
        {
			IntPtr pchTemplateAppKeyUtf8 = Utils.ToUtf8(pchTemplateAppKey);
			IntPtr pchNewAppKeyUtf8 = Utils.ToUtf8(pchNewAppKey);
			EVRApplicationError result = FnTable.LaunchTemplateApplication(pchTemplateAppKeyUtf8,pchNewAppKeyUtf8,keys,(uint) pKeys.Length);
...
public class CVRChaperoneSetup
{
	...
	public unsafe bool GetWorkingCollisionBoundsInfo(out HmdQuad_t[] pQuadsBuffer)
	{
		...
		fixed (HmdQuad_t* buffer = pQuadsBuffer)
        {
			result = FnTable.GetWorkingCollisionBoundsInfo(buffer,ref punQuadsCount);
        }
		return result;
	}
	public unsafe bool GetLiveCollisionBoundsInfo(out HmdQuad_t[] pQuadsBuffer)
	{
		uint punQuadsCount = 0;
		...
		fixed (HmdQuad_t* buffer = pQuadsBuffer)
        {
			result = FnTable.GetLiveCollisionBoundsInfo(buffer,ref punQuadsCount);
        }
		return result;
	}
	...
	public unsafe void SetWorkingCollisionBoundsInfo(Span<HmdQuad_t> pQuadsBuffer)
	{
		fixed (HmdQuad_t* buffer = pQuadsBuffer)
			FnTable.SetWorkingCollisionBoundsInfo(buffer,(uint) pQuadsBuffer.Length);
	}
	public unsafe void SetWorkingPerimeter(Span<HmdVector2_t> pPointBuffer)
	{
		fixed (HmdVector2_t* buffer = pPointBuffer)
			FnTable.SetWorkingPerimeter(buffer,(uint) pPointBuffer.Length);
	}
...
public class CVRCompositor
{
	...
	public unsafe EVRCompositorError WaitGetPoses(Span<TrackedDevicePose_t> pRenderPoseArray,Span<TrackedDevicePose_t> pGamePoseArray)
	{
		fixed (TrackedDevicePose_t* renderPoses = pRenderPoseArray)
		fixed (TrackedDevicePose_t* gamePoses = pGamePoseArray)
        {
			EVRCompositorError result = FnTable.WaitGetPoses(renderPoses,(uint) pRenderPoseArray.Length,gamePoses,(uint) pGamePoseArray.Length);
			return result;

        }
	}
	public unsafe EVRCompositorError GetLastPoses(Span<TrackedDevicePose_t> pRenderPoseArray,Span<TrackedDevicePose_t> pGamePoseArray)
	{
		fixed (TrackedDevicePose_t* renderPoses = pRenderPoseArray)
		fixed (TrackedDevicePose_t* gamePoses = pGamePoseArray)
        {
			EVRCompositorError result = FnTable.GetLastPoses(renderPoses,(uint) pRenderPoseArray.Length,gamePoses,(uint) pGamePoseArray.Length);
			return result;
        }
	}
	...
	public unsafe uint GetFrameTimings(Span<Compositor_FrameTiming> pTiming)
	{
		fixed (Compositor_FrameTiming* ptr = pTiming)
        {
			uint result = FnTable.GetFrameTimings(ptr,(uint) pTiming.Length);
			return result;
        }
	}
	...
	public unsafe EVRCompositorError SetSkyboxOverride(Span<Texture_t> pTextures)
	{
		fixed (Texture_t* ptr = pTextures)
        {
			EVRCompositorError result = FnTable.SetSkyboxOverride(ptr,(uint) pTextures.Length);
			return result;
        }
	}
	...
	public unsafe EVRCompositorError GetPosesForFrame(uint unPosePredictionID,Span<TrackedDevicePose_t> pPoseArray)
	{
		fixed (TrackedDevicePose_t* pPoseArrayPtr = pPoseArray)
        {
			EVRCompositorError result = FnTable.GetPosesForFrame(unPosePredictionID,pPoseArrayPtr,(uint) pPoseArray.Length);
			return result;
        }
	}
}
...
public class CVRScreenshots
{
	...
	public unsafe EVRScreenshotError HookScreenshot(Span<EVRScreenshotType> pSupportedTypes)
	{
		fixed (EVRScreenshotType* pOutput = pSupportedTypes)
        {
			EVRScreenshotError result = FnTable.HookScreenshot(pOutput,(int) pSupportedTypes.Length);
			return result;
        }
	}
...
public class CVRInput
{
	...
	public unsafe EVRInputError UpdateActionState(Span<VRActiveActionSet_t> pSets,uint unSizeOfVRSelectedActionSet_t)
	{
		fixed (VRActiveActionSet_t* sets = pSets)
        {
			EVRInputError result = FnTable.UpdateActionState(sets,unSizeOfVRSelectedActionSet_t,(uint) pSets.Length);
			return result;
        }
	}
	...
	public unsafe EVRInputError GetBoneHierarchy(ulong action,Span<int> pParentIndices)
	{
		fixed (int* parentIndices = pParentIndices)
        {
			EVRInputError result = FnTable.GetBoneHierarchy(action,parentIndices,(uint) pParentIndices.Length);
			return result;
        }
	}
	...
	public unsafe EVRInputError GetSkeletalReferenceTransforms(ulong action,EVRSkeletalTransformSpace eTransformSpace,EVRSkeletalReferencePose eReferencePose,Span<VRBoneTransform_t> pTransformArray)
	{
		fixed (VRBoneTransform_t* transforms = pTransformArray)
        {
			EVRInputError result = FnTable.GetSkeletalReferenceTransforms(action,eTransformSpace,eReferencePose,transforms,(uint) pTransformArray.Length);
			return result;
        }
	}
	...
	public unsafe EVRInputError GetSkeletalBoneData(ulong action,EVRSkeletalTransformSpace eTransformSpace,EVRSkeletalMotionRange eMotionRange,Span<VRBoneTransform_t> pTransformArray)
	{
		fixed (VRBoneTransform_t* transforms = pTransformArray)
        {
			EVRInputError result = FnTable.GetSkeletalBoneData(action,eTransformSpace,eMotionRange,transforms,(uint) pTransformArray.Length);
			return result;
        }
	}
	...
	public unsafe EVRInputError DecompressSkeletalBoneData(IntPtr pvCompressedBuffer,uint unCompressedBufferSize,EVRSkeletalTransformSpace eTransformSpace,Span<VRBoneTransform_t> pTransformArray)
	{
		fixed (VRBoneTransform_t* transforms = pTransformArray)
        {
			EVRInputError result = FnTable.DecompressSkeletalBoneData(pvCompressedBuffer,unCompressedBufferSize,eTransformSpace,transforms,(uint) pTransformArray.Length);
			return result;
        }
	}
	...
	public unsafe EVRInputError GetActionOrigins(ulong actionSetHandle,ulong digitalActionHandle,Span<ulong> originsOut)
	{
		fixed (ulong* origins = originsOut)
        {
			EVRInputError result = FnTable.GetActionOrigins(actionSetHandle,digitalActionHandle,origins,(uint) originsOut.Length);
			return result;
        }
	}
	...
	public unsafe EVRInputError ShowBindingsForActionSet(Span<VRActiveActionSet_t> pSets,uint unSizeOfVRSelectedActionSet_t,ulong originToHighlight)
	{
		fixed (VRActiveActionSet_t* sets = pSets)
        {
			EVRInputError result = FnTable.ShowBindingsForActionSet(sets,unSizeOfVRSelectedActionSet_t,(uint) pSets.Length,originToHighlight);
			return result;
        }
	}
